  ...
  _attachMobileListeners() {
    ...
    if (this.panelEl) {
      ...
      this.panelEl.addEventListener('touchend', e => {
        ...
        if (dx < -60) this._closeDrawer(); // swipe left ≥ 60px
        touchStartX = null;
      }, { passive: true });
    }
  }
